...
export default function AgeMatrix2({ admin }) {
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6 mb-8">
                      ...
                      <div className="text-center md:text-left flex-1">
                        ...
                        <p className="text-gray-600 text-sm md:text-base">
                          Explore our specialized services for {ageGroupsLists[activeTab].title}
                        </p>
                      </div>
                    </div>
                        ...
                        ageGroupsLists[activeTab].services.map((service, i) => (
                          ...
                          >
                            ...
                            >
                              ...
                              <span className="text-[#626262] group-hover:text-[#009C4A] font-semibold text-[16px] text-left capitalize transition-colors duration-200">
                                {service?.name}
                              </span>
                            </Link>
                          </motion.div>
