      ...
      <div className='container mx-auto bg-[#F7F4F0]'>
        <div className=' md:flex bg-[#F7F4F0]'>
          ...
          <div className="md:mt-20 py-4 md:py-8   md:p-0 pt-0 text-left">
            ...
            <h2 className={`heading  poppins text-black tracking-tighter leading-tight font-bold text-4xl md:text-5xl lg:text-5xl mb-3`} >About <span className='text-[#009C4A]'>BlueHaloHealth </span></h2>
            <p className={` text-gray-500 font-medium text-[15px]`}>At BlueHaloHealth, we believe that every family deserves the right support, guidance, and care to thrive at every stage of life. Our mission is to empower children, adolescents, and adults with expert therapy services tailored to their unique needs.</p>
            <p className={` text-gray-500 font-medium text-[15px]`}>With a team of certified and compassionate therapists, we provide evidence-based interventions that nurture growth, improve communication, and strengthen family bonds. From early developmental milestones to adult challenges, we walk alongside families every step of the way.</p>
          </div>
