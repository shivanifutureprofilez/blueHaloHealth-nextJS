...
function BookingTab({title = "Ready To Get Started?",
    description = "Take the first step towards personalized therapy and support. Our team is here to help you navigate your journey.",
    email = "info@bluehalohealth.com",
    tagline = "15 MIN Consultation On Us."}) {
    return (
                ...
                <section className="overflow-hidden w-full relative  flex items-center justify-center ">
                    ...
                    px-[20px] py-[40px] md:py-[60px] md:px-[30px] rounded-2xl overflow-hidden">
                        ...
                        <div className="w-full z-[1]" >
                            <Heading className="!text-white heading text-center md:text-left poppins  tracking-tighter leading-tight font-bold text-2xl md:text-3xl md:mt-1 md:mb-1" heading1={title} />
                            <p className="text-center text-[16px] text-white p-2 md:p-4 max-w-[600px] mx-auto">{description}</p>
                            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 bg-[#0000001A] rounded-lg py-3 px-3 mx-auto max-w-[600px]">
                                ...
                                <Link
                                    ...
                                    className="flex items-center gap-2 font-semibold md:font-bold text-white hover:text-[#00D967] transition"
                                >
                                    <IoMailOpenOutline size={24} /> {email}
                                </Link>
                            </div>
                            <div className="flex mt-4 flex-wrap bg-[#0000001A] items-center justify-center gap-x-6 gap-y-2  rounded-lg py-3 md:py-0 md:px-3 mx-auto max-w-[600px]">
                                <p className="uppercase tagline rounded-lg font-bold text-xl md:text-2xl  p-3 text-center">{tagline}</p>
                                {/* <AnimationTry/> */}
                            </div>
