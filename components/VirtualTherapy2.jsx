    ...
    <div className='bg-[#F7F4F0] py-[40px]  lg:py-[60px] overflow-hidden '>
      <div className='mx-auto container  px-4 text-center'>
        <div className="flex justify-between items-center lg:gap-8">
          ...
          <div className="text-center lg:text-left lg:max-w-[65%] w-full">
            <div className="leading-snug px-6">
              <h2  className="heading poppins text-black tracking-tighter leading-tight font-bold text-2xl md:text-3xl xl mb-3">
                Virtual <span className="text-[#009C4A]">Therapy</span>
              </h2>
             
              <p className="text-black font-lg !text-[16px] mb-5 lg:mb-4 " >At Blue Halo Health, we’re revolutionizing Ontario’s healthcare landscape with a bold vision: a seamless, province-spanning ecosystem where healing happens on your terms.</p>
...
<p className='text-gray-500 font-medium text-[15px]'>From developmental milestones to life’s most complex challenges, BlueHaloHealth delivers the guidance, connection, and care needed to help individuals and families thrive—virtually, together.              </p> */}
              <div className='flex item-center justify-center lg:block'>
                <ul className="space-y-4 text-base" >
                  <li className="flex  gap-6 lg:gap-3 text-black">
                    <span className="">
                  ...
                  <li className="flex items-center gap-6 lg:gap-3 text-black">
                    <span className="">
          ...
          <div className='lg:max-w-[35%] w-full hidden lg:block'>
            <Image
              src="/virtual.png"
