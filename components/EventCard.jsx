...
function EventCard({item, index}) {
    ...
    {item ? <>
        <div
            key={index}
            className="m-3 md:m-0 bg-white rounded-2xl border border-gray-200 shadow flex flex-col p-8 text-center"
        >
            ...
            <Link href="/" className="text-green-600 font-semibold text-center justify-center items-center flex items-center gap-1 hover:underline">
                {item?.link}
