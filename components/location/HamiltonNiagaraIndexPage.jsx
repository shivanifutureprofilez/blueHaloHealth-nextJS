        ...
        <section className="py-14 container mx-auto">
          ...
          <div className="my-10 bg-[#f2ede8] rounded-2xl p-8 md:p-10 shadow-sm text-center relative overflow-hidden">
            ...
            <p className="text-gray-700 leading-relaxed max-w-[650px] mx-auto mb-4">
              Start virtual care from home and connect with experienced clinicians without the stress of travel.
            </p>
            ...
            <div className="container mx-auto px-4 max-w-6xl">
              ...
              <div className="text-center mb-12">
                ...
                <p className="mt-3 text-gray-700 max-w-[700px] mx-auto">
                  ...
                  across the Hamilton and the Niagara Region.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#e8e3da]">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    For many families in Hamilton and the Niagara Region, accessing specialized services often requires travelling across cities or waiting for limited local availability.
                  </p>

                  <p className="text-gray-700 leading-relaxed">
                    Our virtual mental health and developmental care model helps remove those barriers by connecting families directly with clinicians through secure online sessions.
                  </p>

                  <p className="text-gray-700 leading-relaxed mt-4">
                    Families in Hamilton, Burlington, St. Catharines, and Niagara Falls can access the same high-quality support from home while maintaining flexible scheduling that fits around school and work commitments.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#e8e3da]">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    In-person care is only recommended when your clinician determines it is necessary to achieve certain goals. If ongoing in-person support is required beyond our services, our team will help connect you with the appropriate local providers.
                  </p>
            ...
            <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <h2 className="heading text-green-dark mb-4">
                  How BlueHaloHealth Virtual Care Improves Access for Hamilton–Niagara Families
                </h2>

                <p className="text-gray-700 leading-relaxed mb-4">
                  Families across the region often face limited specialist availability and travel demands when seeking developmental or mental health services. For parents balancing work schedules, school commitments, and family life, attending appointments across different cities can quickly become overwhelming.

                </p>

                <p className="text-gray-700 leading-relaxed mb-4">
                  Virtual care helps reduce these barriers by allowing families to access coordinated developmental and mental health services in Ontario while maintaining regular therapy schedules from home.
                </p>
          ...
          <section className="py-8 bg-[#F7F4F0]">
            <div className="container mx-auto px-4">
              ...
              <div className="grid md:grid-cols-2 gap-10 items-center mb-14">
                <div>
                  <h2 className="heading text-green-dark mb-4">
                    Supporting Families Across Hamilton & Niagara with Virtual Autism, Counselling & Speech Therapy
                  </h2>

                  <p className="text-gray-700 leading-relaxed mb-4">
                    Families from Hamilton, Burlington, St. Catharines, Niagara Falls, and nearby communities regularly connect with our team for accessible developmental and mental health support. Many parents share that travelling across the region for appointments can be difficult, particularly when managing school routines or multiple activities.
                  </p>

                  <p className="text-gray-700 leading-relaxed">
                    Our virtual therapy services for families in the Hamilton–Niagara region allow children and parents to receive consistent care while staying close to home.
                  </p>
                </div>
                ...
                <div className="relative h-[320px] md:h-[360px] rounded-2xl overflow-hidden shadow-sm">
                  <Image
                    src="/banner10.jpg"
                    alt="Virtual therapy for families across Hamilton and surrounding regions"
                    fill
                    className="object-cover"
                  />
                </div>
              ...
              <div className="text-center max-w-[720px] mx-auto pt-3 mb-8">
                <h3 className="heading text-black">
                  Services Available in Hamilton–Niagara
                </h3>
                <p className="text-gray-700 mt-3 pb-6">
                  Families in Hamilton–Niagara region can access our
        ...
        <section className="bg-[#4B9B711A] py-14 ">
          <div className="mx-auto container px-4 text-center">
            <Heading
              ...
              heading1={"Why Families in Hamilton–Niagara Choose"}
              heading2={" Blue Halo Health"}
            />
            <p className="mb-6 md:mb-2 font-medium text-[15px] text-center text-gray-700 max-w-[650px] mx-auto">
              Families across the region choose Blue Halo Health because we combine experienced clinicians with a flexible virtual care model. Our team focuses on providing coordinated services that address developmental and emotional needs while helping families access support sooner.
            </p>
          ...
          <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Heading
                ...
                heading2={" Across Hamilton & Niagara"}
              />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-[#F7F4F0] rounded-xl p-5 flex items-start gap-3">
                ...
                <p className="text-gray-700 text-[15px] font-medium">
                  Experienced in autism services in Hamilton
                </p>
              </div>
              ...
              <div className="bg-[#F7F4F0] rounded-xl p-5 flex items-start gap-3">
                ...
                <p className="text-gray-700 text-[15px] font-medium">
                  Specialized speech therapy in the Niagara region
                </p>
              </div>
              ...
              <div className="bg-[#F7F4F0] rounded-xl p-5 flex items-start gap-3">
                ...
                <p className="text-gray-700 text-[15px] font-medium">
                  Support for child and teen counselling in Hamilton–Niagara
                </p>
              </div>
